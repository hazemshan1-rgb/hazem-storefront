...
export function ResourcesPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)] pt-24 pb-24">
      ...
      {/* Coming training */}
      <section className="max-w-6xl mx-auto px-6 mt-20 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={course.title} className="bg-[var(--color-surface)] border border-[var(--color-gold-muted)] rounded-sm p-6 flex flex-col gap-4">
              <div className="flex items-start justify-between gap-3">
